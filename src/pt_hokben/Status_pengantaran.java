 ...
 * @author dasep
 */
public class Status_pengantaran extends javax.swing.JFrame {

     private String id ;
    /** Creates new form Laporan */
    public Status_pengantaran() {
        initComponents();
        loadPesanan(this.id);
    }
    ...
    private void initComponents() {
        ...
        laporan.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Pesanan", "Nama Pemesan", "Tanggal Kirim", "Tanggal Sampai", "Status"
            }
        ));
        ...
        jLabel1.setText("STATUS PENGANTARAN");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(230, 10, 280, 22);
    ...
    private void pdfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pdfActionPerformed
        ...
        my_pdf_report.open();            
        my_pdf_report.add(new Paragraph("Laporan Status Pengantaran",FontFactory.getFont(FontFactory.TIMES_BOLD, 18, Font.BOLD, BaseColor.BLUE)));
        ...
        my_report_table.addCell("Tanggal Kirim");
        my_report_table.addCell("Tanggal Sampai");
        ...
        while (res.next()) {                
            ...
            String tgl1     = res.getString("tanggal_kirim");
            table_cell=new PdfPCell(new Phrase(tgl1));
            my_report_table.addCell(table_cell);
            
            String tgl     = res.getString("tanggal_sampai");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Status_pengantaran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Status_pengantaran().setVisible(true);
            }
        });
    }
    ...
    public void loadPesanan(String data){
        ...
        try {
            ...
            if(data == null ){
                sql = "select id_pesanan , nama_penerima , alamat , tanggal_kirim , tanggal_sampai ,status"
                        + " from form_transaksi " ;
            }else {
                sql = "Select * from form_transaksi where "
                        + "id_pesanan  = '"+ data +"' "                 
                        + "or nama_penerima  = '"+ data +"'    "  ;                
            }
            java.sql.Connection conn = (Connection)koneksi.configDB();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
